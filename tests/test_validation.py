...
def _validate_against_model(data: Any, model: type[BaseModel], should_be_valid: bool) -> None:
    if should_be_valid:
        try:
...
def test_judge_p1_schema_valid():
    ...
    _validate_against_model(valid_data, JudgeP1Model, True)
...
def test_judge_p1_schema_invalid_missing_required():
    ...
    _validate_against_model(invalid_data, JudgeP1Model, False)
...
def test_delta_schema_valid_full():
    ...
    _validate_against_model(valid_data, DeltaModel, True)
...
def test_delta_schema_valid_minimal():
    ...
    _validate_against_model(valid_data_empty, DeltaModel, True)


def test_delta_schema_invalid_pain_type():
    invalid_data = {C.PAIN_INCREASE: "high"}  # Should be integer
    _validate_against_model(invalid_data, DeltaModel, False)
...
def test_delta_schema_invalid_additional_property():
    # DeltaModel forbids extra fields
...
def test_judge_p2_schema_valid():
    ...
    _validate_against_model(valid_data, JudgeP2Model, True)
...
def test_judge_p2_schema_invalid_missing_narration():
    ...
    _validate_against_model(invalid_data, JudgeP2Model, False)
